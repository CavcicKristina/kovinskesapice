...
if(isset($_GET['type']) && $_GET['type'] == 'delete' && isset($_GET['id']) && !empty($_GET['id'])){
  deleteArticleWithCategory($_GET['id']);
} 
  ...
  <div class="col-sm-6 col-md-3">
    <a href="default.php" class="products-card block-link">
        ...
        <div class="card-body">
            ...
            <p class="card-text">Povratak na članke</p>    
        </div>    
        </div>
    </a>
  </div> 
  <div class="col-sm-6 col-md-3">
    <a href="page2_new.php" class="products-card block-link">
        <div class="card text-white text-center mb-3">   
        <div class="card-body">
            <h5 class="card-title">DODAJ ČLANAK</h5>
            <p class="card-text">Unošenje novog članka</p>    
        </div>    
        </div>
    </a>
  </div>
            ...
            <div class="card text-white text-center mb-3 bg-kateg"> 
              <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                  <li class="nav-item">
                    <a class="btn btn-primary block-link" href="page2_edit.php?id='.$blog['id'].'">Edit</a>
                  </li>                  
                  <li class="nav-item">
                    <button class="btn btn-primary" data-toggle="modal" data-backdrop="static" data-target="#deleteConfirm" data-link="page2.php?type=delete&id='.$blog['id'].'">Delete</button>
                  </li>
              ...
              <img class="card-img-top" src="'.$blog['show'].'" alt="Card image cap">              
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body py-4">
        Obrisati članak "<span class="font-weight-bold"></span>"?
      </div>
