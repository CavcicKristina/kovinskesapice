...
<div class="row no-gutters">
  ...
  <div class="col-sm-6 col-md-3">
    <a href="cats_new.php" class="products-card block-link">
        <div class="card text-white text-center mb-3">   
        <div class="card-body">
            <h5 class="card-title">DODAJ MAČKU</h5>
            <p class="card-text">Unošenje novog mačke</p>    
        </div>    
        </div>
    </a>
  </div>
            ...
            <div class="card text-white text-center mb-3 bg-kateg"> 
              <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                  <li class="nav-item">
                    <a class="btn btn-primary block-link" href="cats_edit.php?id='.$blog['id'].'">Edit</a>
                  </li>                  
                  <li class="nav-item">
                    <button class="btn btn-primary" data-toggle="modal" data-backdrop="static" data-target="#deleteConfirm" data-link="cats.php?type=delete&id='.$blog['id'].'">Delete</button>
                  </li>
                  ...
                  <input type="checkbox" class="checkbox-toggle" '.($blog['active'] == '1' ? 'checked' : '').' data-toggle="toggle" data-id="'.$blog['id'].'" data-field="active" data-page="cats_sys.php" data-size="md">
                  </li>
                </ul>
              </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body py-4">
        Obrisati mačku "<span class="font-weight-bold"></span>"?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Odustani</button>
        <a type="button" class="btn btn-primary" href="cats.php">Obriši</a>
      </div>
    </div>
  </div>
</div>
