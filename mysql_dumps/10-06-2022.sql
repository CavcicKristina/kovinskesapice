...
INSERT INTO `cms_users` VALUES (1,'admin','$2y$10$STk4ZBbVZ2a./JZpscyvX.o.90qoHLE5px7CZOwRgUaKnAUqIIoFW',NULL,'2022-06-10 13:13:23','::1',1),(2,'kovinske šapice','$2y$10$5pwYDi8SEsrI5XQg3ev8be9SGaQj8cBLuLPVQlnEbf0zHkaGIfe9C',NULL,'2022-05-23 11:37:32','::1',2);
...
DROP TABLE IF EXISTS `contact_msgs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `contact_msgs` WRITE;
/*!40000 ALTER TABLE `contact_msgs` DISABLE KEYS */;
/*!40000 ALTER TABLE `contact_msgs` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `dogs` VALUES (11,'Pesonja',1,1,'musko','mlado','peso','srednja',0,0,1,0,0,0,0,1,'2022-06-09 17:29:54','qweqweqwe\r\nqweqw\r\nqwwwwww\r\nqqq',4,'pesonja');
